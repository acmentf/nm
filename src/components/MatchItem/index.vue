...
<template>
  ...
  <div class="match-item">
    <div class="mounted" @click="goDetail(item_data.base.match_id)">
      <div class="item-top">
      ...
      <div class="item-middle">
        <Star
          ref="star"
          v-model="item_data.is_focus"
          :parmars="{game_id,type:'0',id_list:item_data.base.match_id}"
        />
        <div class="team">
          <div class="home">
            <span
            ...
            <Economic
              ...
              v-show="item_data.info.home.economic>0"
              class="economic-left"
            />
            <span
              class="team-score"
          ...
          <div class="away">
            ...
            <Economic
              ...
              v-if="item_data.info.away.economic>0"
        ...
        <span v-if="item_data.base.status_id !==2" style="position:relative;z-index:111">
          <img src="./icon/LOL.svg" alt v-if="game_id=='LOL'" class="game-icon" />
          <img src="./icon/CSGO.svg" alt v-if="game_id=='CSGO'" class="game-icon" />
          <img src="./icon/DOTA2.svg" alt v-if="game_id=='DOTA2'" class="game-icon" />
        </span>
      </div>
      <div class="item-bottom">
        <span
          class="start-time"
        >{{item_data.base.match_time ? $format(item_data.base.match_time,'hh:mm') :''}}</span>
        <!-- 全场比分 -->
        ...
        <span class="online-count" v-if="item_data.info.room_persons">
          <i class="rs"></i>
          <span>{{item_data.info.room_persons}}</span>
        </span>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    goDetail(match_id) {
      switch (this.game_id) {
        case "LOL":
          this.$router.push("/match-detail/LOL?match_id=" + match_id);
          break;
        case "DOTA2":
          this.$router.push("/match-detail/DOTA2?match_id=" + match_id);
          break;
        case "CSGO":
          this.$router.push("/match-detail/CSGO?match_id=" + match_id);
          break;
      }
    },
