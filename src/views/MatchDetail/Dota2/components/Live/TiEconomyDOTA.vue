...
-->
<template>
  <div :class="$options.name" alt="经济曲线图组件" v-bind:[$options.name]="$options.version">
    <!-- {{ data }} -->
    <Module :alt="title">
...
export default {
        ...
        */
        ...
        series: [
...

          {
            ...
            //填充的颜色。
            //
            //background: linear-gradient(180deg, rgba(42, 183, 202, 0.5) 0%, rgba(128, 128, 128, 0) 100%);
            //
            areaStyle: {
              color: new $echarts.graphic.LinearGradient(0, 0, 0, 1, [
                {
                  offset: 0,
                  color: "rgba(40, 98, 229, 0.5)"
                },
                {
                  offset: 1,
  ...
  computed: {
    economics_info() {
      // console.log('---computed.economics_info---', JSON.stringify(this.data.ecolist));
      // return false;
      var _data = {
        ecolist: [],
        explist: [],
