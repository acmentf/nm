    ...
    >
      ...
      <div class="blue">
        <div class="title" :team_id="data.role_attr_info_home.team_id">
          <MyImage
            class="logo"
            v-model="data.role_attr_info_home.team_img"
            :type="1"
          />
          ...
          <dd>
            <span
              ...
              <i>{{ data.role_attr_info_home.total.money || 0 }}</i></span
            >
            <span
              ...
              <i
                ...
                }}/{{ data.role_attr_info_home.total.assists || 0 }}</i
              ></span
            >
          </dd>
        </div>
        <div class="list">
          <div
            class="line"
            v-for="(item, index) in data.role_attr_info_home.player"
            :key="index"
          >
            <div class="con">
              <div class="pic">
              ...
              <div class="bag">
                <h3 :player_id="item.play_info.player_id">
                  {{ item.play_info.player_name || "[玩家]" }}
                </h3>
                <div class="icon">
                  <MyImage
              ...
              <div class="data">
                <div class="box">
                  <p>
                    <span class="up"
                      ><img src="../../images/gold_away.png" />
                      <i>{{ item.play_info.money || 0 }}</i></span
                    >
                    <span class="in"
                      ><MyImage
                        v-for="(e_item, e_index) in item.play_info.spells"
                        :key="e_index"
                        v-model="item.play_info.spells[e_index]"
                        :type="4"
                    /></span>
                  </p>
                  <p>
                    <span class="up"
                      ...
                      <i
                        ...
                        }}/{{ item.play_info.assists || 0 }}</i
                      ></span
                    >
                    <!-- <span class="in">GPM<b>{{item.play_info.gpm||"-"}}</b></span> -->
                  </p>
                </div>
              </div>
            </div>
            <TicollapseLOL>
              <div class="collapsebox">
                <span
                  ><i>KDA：</i><b>{{ item.play_info.kda || "-" }}</b></span
                >
                <span
                  ><i>补刀：</i
                  ><b>{{ item.play_info.soldiers || "-" }}</b></span
                >
                <span
                  ><i>参团率：</i
                  ><b>{{ item.play_info.group_rate || "-" }}</b></span
                >
                <span
                  ><i>伤害：</i><b>{{ item.play_info.attack || "-" }}</b></span
                >
                <span
                  ><i>承伤：</i><b>{{ item.play_info.bear || "-" }}</b></span
                >
              </div>
            </TicollapseLOL>
          </div>
      ...
      <div class="red">
        <div class="title" :team_id="data.role_attr_info_away.team_id">
          <MyImage
            class="logo"
            v-model="data.role_attr_info_away.team_img"
            :type="1"
          />
          ...
          <dd>
            <span
              ...
              <i>{{ data.role_attr_info_away.total.money || 0 }}</i></span
            >
            <span
              ...
              <i
                ...
                }}/{{ data.role_attr_info_away.total.assists || 0 }}</i
              ></span
            >
          </dd>
        </div>
        <div class="list">
          <div
            class="line"
            v-for="(item, index) in data.role_attr_info_away.player"
            :key="index"
          >
            <div class="con">
              <div class="pic">
...
import TicollapseLOL from "./TicollapseLOL";
export default {
  name: "TIEquipLOL",
  ...
  props: ["title", "data"],
  // 局部注册的组件
  components: { Module, TicollapseLOL },
  data() {
    return {
      activeName: "1",
    };
